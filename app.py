...
# weather = pd.read_csv(
#     r"D:\My_Projects\Python_Projects\Indian Weather Data Analysis\Main_Dataset\Indian_Weather_Consolidated.csv"
# )
...
# if selected_page == "Page 1 — Temperature & Heat":

#     st.title("🌡️ Page 1 — Temperature & Heat Analysis")
...
#         • Inland cities generally show greater temperature extremes
#         compared with coastal **Bombay**.
#         """
#     )
...
#     max_city = city_max_temp.loc[
#         city_max_temp["maxtempC"].idxmax()
#     ]

#     min_max_city = city_max_temp.loc[
#         city_max_temp["maxtempC"].idxmin()
#     ]
...
#         • **{max_city['city']}** recorded the highest temperature at
#         **{max_city['maxtempC']:.0f}°C**.

#         • **{min_max_city['city']}** recorded the lowest maximum temperature
#         among the cities at approximately **{min_max_city['maxtempC']:.0f}°C**.

#         • The results show substantially higher temperature extremes
#         in inland cities compared with coastal Bombay.
#         """
#     )
...
#         • **{hottest_month['Month']}** is the hottest month with an
#         average temperature of approximately **{hottest_month['tempC']:.2f}°C**.

#         • **{coolest_month['Month']}** is the coolest month with an
#         average temperature of approximately **{coolest_month['tempC']:.2f}°C**.

#         • Temperature increases sharply from winter toward the
#         summer months.

#         • Temperatures gradually decline after the summer peak.
#         """
#     )
...
#         • Northern and central cities such as **Delhi, Jaipur, Kanpur
#         and Nagpur** show stronger seasonal temperature variation.

#         • **Bengaluru and Bombay** show comparatively stable temperatures.

#         • The highest city-month average temperature is approximately
#         **{max_city_month_value:.2f}°C**, observed for
#         **{city_month_max[0]} during {city_month_max[1]}**.

#         • Seasonal differences are more pronounced in inland cities.
#         """
#     )
...
#         • The difference between the hottest and coolest seasonal
...
#         • Heat Index incorporates the effect of atmospheric conditions
#         such as humidity and therefore can differ from air temperature.

#         **Key Finding:** Air temperature alone does not completely represent
#         perceived heat.
#         """
#     )
...
#                 customdata=monthly_stats[
#                     "Heat_Stress_Difference"
#                 ],
#                 hovertemplate=(
#                     "<b>%{x}</b><br>"
#                     "Average Temperature: %{y:.2f}°C<br>"
#                     "Heat Stress Difference: %{customdata:.2f}°C"
#                     "<extra></extra>"
#                 )
#             )
#         )
...
#             "Heat Stress Difference (°C)"
#         ]

#         st.dataframe(
#             display_stats.round(2),
#             use_container_width=True,
#             hide_index=True
#         )
...
#             • The largest difference between Heat Index and actual
#             temperature occurs in **{max_stress['Month']}** at
#             **{max_stress['Heat_Stress_Difference']:.2f}°C**.

#             • The highest average Heat Index occurs in
#             **{max_heat_index['Month']}** at
#             **{max_heat_index['Avg_Heat_Index']:.2f}°C**.

#             • A larger difference indicates that environmental conditions
#             contribute more strongly to perceived heat during that month.
#             """
#         )
...
#         The combined dataset shows a correlation of approximately
#         **{correlation:.3f}** between humidity and Heat Index.

#         This represents the overall relationship across multiple cities,
#         seasons and years. The relationship can vary considerably
...
#     # ========================================================
#     # CITY-WISE HUMIDITY CORRELATION
#     # ========================================================
...
#     highest_positive = city_correlation.loc[
#         city_correlation["correlation"].idxmax()
#     ]

#     lowest_correlation = city_correlation.loc[
#         city_correlation["correlation"].idxmin()
#     ]
...
#         • **{highest_positive['city']}** has the strongest positive
#         humidity–Heat Index correlation at approximately
#         **{highest_positive['correlation']:.3f}**.

#         • **{lowest_correlation['city']}** has the lowest correlation
#         at approximately **{lowest_correlation['correlation']:.3f}**.

#         • The strongest relationship in absolute terms is observed in
#         **{strongest_city['city']}**, with a correlation of
#         **{strongest_city['correlation']:.3f}**.

#         • The variation between cities shows that the relationship between
#         humidity and Heat Index is not uniform across the dataset.
#         """
#     )
...
#         - Temperature generally peaks during the **summer months**.
#         - **January** represents the cooler end of the annual temperature cycle.
#         - **Delhi, Jaipur, Kanpur and Nagpur** show strong seasonal temperature variation.
#         - **Bombay** can experience a relatively high Heat Index despite not having the highest average air temperature.
#         - **Bengaluru** generally experiences lower heat conditions.
#         - Heat Index provides additional information beyond air temperature alone.
#         - Humidity–Heat Index relationships vary by city.
#         """
#     )
...
#     st.title("☀️ Page 2 — UV, Sunshine & Rainfall")
...
#     highest_avg_uv = city_uv.loc[
#         city_uv["Avg_UV"].idxmax()
#     ]

#     lowest_avg_uv = city_uv.loc[
#         city_uv["Avg_UV"].idxmin()
#     ]

#     highest_max_uv = city_uv.loc[
#         city_uv["Max_UV"].idxmax()
#     ]
...
#         • **{highest_avg_uv['city']}** has the highest average UV exposure
#         at approximately **{highest_avg_uv['Avg_UV']:.2f}**.

#         • **{lowest_avg_uv['city']}** has the lowest average UV exposure
#         at approximately **{lowest_avg_uv['Avg_UV']:.2f}**.

#         • **{highest_max_uv['city']}** reaches the highest observed
#         UV Index of **{highest_max_uv['Max_UV']:.0f}**.

#         • Average exposure and peak UV exposure can produce different
#         city rankings.
#         """
#     )
...
#         • **{peak_uv_month['Month']}** has the highest average UV exposure
#         at approximately **{peak_uv_month['Avg_UV']:.2f}**.

#         • **{lowest_uv_month['Month']}** has the lowest average UV exposure
#         at approximately **{lowest_uv_month['Avg_UV']:.2f}**.

#         • UV exposure increases substantially from the early-year months
#         toward **April–June**.

#         • UV exposure declines after the main summer peak.
#         """
#     )


#     # ========================================================
#     # 3. AVERAGE SUNSHINE DURATION BY CITY
#     # ========================================================

#     st.header("3. Average Sunshine Duration by City")
...
#         x="city",
#         y="sunHour",
#         title="Average Sunshine Duration by City (2009–2019)",
#         labels={
#             "city": "City",
...
#     highest_sunshine = city_sunshine.loc[
#         city_sunshine["sunHour"].idxmax()
#     ]

#     lowest_sunshine = city_sunshine.loc[
#         city_sunshine["sunHour"].idxmin()
#     ]

#     difference_sunshine = (
#         highest_sunshine["sunHour"]
#         - lowest_sunshine["sunHour"]
#     )
...
#         • **{highest_sunshine['city']}** has the highest average sunshine
#         duration at approximately **{highest_sunshine['sunHour']:.2f} hours/day**.

#         • **{lowest_sunshine['city']}** has the lowest average sunshine
#         duration at approximately **{lowest_sunshine['sunHour']:.2f} hours/day**.

#         • The difference between the highest and lowest city averages is
#         approximately **{difference_sunshine:.2f} hours/day**.

#         • Overall sunshine duration is relatively similar across the
#         analyzed cities.
#         """
#     )
...
#     # ========================================================
#     # 4. CLOUD COVER VS SUNSHINE HOURS
#     # ========================================================

#     st.header("4. Cloud Cover vs Sunshine Hours")

#     cloud_sun_correlation = (
#         weather["cloudcover"]
#         .corr(
#             weather["sunHour"]
#         )
...
#         approximately **{cloud_sun_correlation:.3f}**.

#         • The negative relationship indicates that higher cloud cover
#         generally corresponds to fewer sunshine hours.

#         • However, the relationship is not perfectly negative, showing
#         that cloud cover alone does not explain all variation in
#         sunshine duration.

#         • Season, location and atmospheric conditions can also influence
...
#     st.header("5. Total Precipitation by City (2009–2019)")
...
#     wettest_city = city_rainfall.loc[
#         city_rainfall["precipMM"].idxmax()
#     ]

#     driest_city = city_rainfall.loc[
...
#         • **{wettest_city['city']}** records the highest cumulative
#         precipitation at approximately **{wettest_city['precipMM']:,.1f} mm**.

#         • **{driest_city['city']}** records the lowest cumulative
#         precipitation at approximately **{driest_city['precipMM']:,.1f} mm**.

#         • The results show substantial differences in cumulative rainfall
#         between the cities.

#         • Coastal and monsoon-influenced cities generally accumulate
#         greater rainfall than the drier northern cities.
#         """
#     )
...
#     st.header("6. Monthly Precipitation")
...
#         • **{wettest_month['Month']}** is the wettest month with cumulative
#         precipitation of approximately **{wettest_month['precipMM']:,.1f} mm**.

#         • **{driest_month['Month']}** records the lowest cumulative
#         precipitation at approximately **{driest_month['precipMM']:,.1f} mm**.

#         • Rainfall is strongly concentrated during the **June–September**
#         period.

#         • The pattern indicates a strong seasonal rainfall cycle associated
#         with the monsoon period.
#         """
#     )


#     # ========================================================
#     # 7. HIGHEST DAILY RAINFALL EVENT
#     # ========================================================

#     st.header("7. Highest Daily Rainfall Event by City")
...
#         x="city",
#         y="daily_precipMM",
#         title="Highest Daily Rainfall Event by City (2009–2019)",
#         labels={
#             "city": "City",
...
#         • **{highest_daily_city['city']}** experienced the highest single-day
#         rainfall event at approximately
#         **{highest_daily_city['daily_precipMM']:.1f} mm**.

#         • **{lowest_daily_city['city']}** recorded the lowest maximum daily
#         rainfall event at approximately
#         **{lowest_daily_city['daily_precipMM']:.1f} mm**.

#         • The difference between cities indicates substantial variation
#         in extreme rainfall intensity.

#         • Maximum daily rainfall is useful for identifying potential
...
#     st.markdown(
#         """
#         - UV exposure follows a strong seasonal pattern, with elevated
#           levels generally occurring during **April–June**.
#         - **Kanpur, Nagpur, Delhi and Jaipur** show comparatively high
#           UV exposure.
#         - **Bengaluru** generally records lower UV exposure.
#         - Sunshine duration is relatively similar across cities, with
#           **Jaipur and Delhi** among the highest.
#         - Cloud cover has a negative relationship with sunshine duration,
#           although the relationship is not strong.
#         - Rainfall is strongly concentrated during the **monsoon months**.
#         - **Bombay** records the highest cumulative precipitation.
#         - **July** represents the strongest rainfall month in the dataset.
#         - Maximum daily rainfall highlights the intensity of extreme
#           rainfall events rather than total rainfall alone.
#         """
#     )
